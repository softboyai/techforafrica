  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: "radial-gradient(circle, #1E4A5F18 1px, transparent 1px)",
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-5 lg:px-8 py-20 lg:py-28 w-full">
        <div className="grid lg:grid-cols-[1fr_480px] gap-10 lg:gap-16 items-center">
          ...
          <div>
            ...
            <p
              className="text-base lg:text-lg text-[#22262B]/65 leading-relaxed mb-9 max-w-xl"
            ...
            <div className="flex flex-wrap gap-4 items-center">
              ...
              <a href="#courses" className="btn-brutal btn-brutal-ghost">
                {hero.secondaryCta}
              </a>
            </div>
          ...
          {/* ── Right: student photo — visible on ALL screen sizes ── */}
          <div className="relative w-full">
            {/* Colour accent block offset behind photo */}
            <div
            ...
            {/* Photo */}
            <div
              className="relative border-2 border-[#22262B] overflow-hidden"
            ...
            >
              <Image
                ...
                width={480}
                height={600}
                className="w-full h-auto object-cover object-top max-h-[70vh] lg:max-h-none"
                priority
              />
              ...
              <div
                ...
                style={{ background: "linear-gradient(to top, #22262Bbb, transparent)" }}
                aria-hidden="true"
              />
      ...
      <div
        className="absolute bottom-0 left-0 right-0 h-20 pointer-events-none"
        style={{ background: "linear-gradient(to bottom, transparent, #EFEDE8)" }}
        aria-hidden="true"
      />
    </section>
  );
